...
const Consulta: React.FC = () => {
  ...
  const [k, setK] = useState<number>(10);       //Default top 10 most similar songs
  ...
  const searchSPIMI = () => {
    fetch('http://localhost:5000/search/spimi', { //TODO: adapt this to supabase. Maybe with an api
      method: 'POST',
  ...
  return (
    <div className="Consulta">
      <h1>Type some lyrics!</h1>
      <div>
        <label htmlFor="query"> Whatever you remember</label>
        <input
          type="text"
          id="query"
          value={query}
      ...
      <div>
        <label htmlFor="k">Top songs</label>
        <input
          type="number"
          id="k"
          value={k}
      ...
      <div className="botones-container">
        <button onClick={searchSPIMI}>Search</button>
      </div>
